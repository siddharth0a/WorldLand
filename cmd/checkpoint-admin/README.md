...
```shell
go get github.com/cryptoecc/WorldLand/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/cryptoecc/WorldLand/blob/master/params/config.go#L251).*
